...
```
    ...
    ## INFO [2026-07-29 19:13:50] Creating directory './examples' for saving zip file.
...
```
    ...
    ## INFO [2026-07-29 19:13:50] Starting workflow run with ID: '20260729191350_19cb283f'

    ## INFO [2026-07-29 19:13:50] Running step 1 of 5

    ## INFO [2026-07-29 19:13:50] Parsing arguments for command simple_split

    ## INFO [2026-07-29 19:13:50]   1 sample x iteration runs for command 'simple_split':

    ## WARN [2026-07-29 19:13:50]      WARNING! Multiple results per iteration! Ensure that downstream steps handle list inputs.

    ## INFO [2026-07-29 19:13:50] Running step 2 of 5

    ## INFO [2026-07-29 19:13:50] Parsing arguments for command fetch_WebText

    ## INFO [2026-07-29 19:13:51]   2 sample x iteration runs for command 'fetch_WebText':

    ## INFO [2026-07-29 19:13:51]      2 single results.

    ## INFO [2026-07-29 19:13:51] Running step 3 of 5

    ## INFO [2026-07-29 19:13:51] Parsing arguments for command paste

    ## WARN [2026-07-29 19:13:51] WARNING! Detected list argument(s) for command 'paste', but 'iteration' is set to 'no'.

    ## INFO [2026-07-29 19:13:51]   1 sample x iteration runs for command 'paste':

    ## INFO [2026-07-29 19:13:51]      1 single results.

    ## INFO [2026-07-29 19:13:51] Running step 4 of 5

    ## INFO [2026-07-29 19:13:51] Parsing arguments for command gsub

    ## INFO [2026-07-29 19:13:51]   1 sample x iteration runs for command 'gsub':

    ## INFO [2026-07-29 19:13:51]      1 single results.

    ## INFO [2026-07-29 19:13:51] Running step 5 of 5

    ## INFO [2026-07-29 19:13:51] Parsing arguments for command simple_split

    ## INFO [2026-07-29 19:13:52]   1 sample x iteration runs for command 'simple_split':

    ## WARN [2026-07-29 19:13:52]      WARNING! Multiple results per iteration! Ensure that downstream steps handle list inputs.
...
```
    ...
    ## INFO [2026-07-29 19:13:53] Starting workflow run with ID: '20260729191353_01e47766'

    ## INFO [2026-07-29 19:13:53] Running step 1 of 4

    ## INFO [2026-07-29 19:13:53] Parsing arguments for command simple_split

    ## INFO [2026-07-29 19:13:53]   1 sample x iteration runs for command 'simple_split':

    ## WARN [2026-07-29 19:13:53]      WARNING! Multiple results per iteration! Ensure that downstream steps handle list inputs.

    ## INFO [2026-07-29 19:13:53] Running step 2 of 4

    ## INFO [2026-07-29 19:13:53] Parsing arguments for command fetch_WebText

    ## INFO [2026-07-29 19:13:54]   2 sample x iteration runs for command 'fetch_WebText':

    ## INFO [2026-07-29 19:13:54]      2 single results.

    ## INFO [2026-07-29 19:13:54] Running step 3 of 4

    ## INFO [2026-07-29 19:13:54] Parsing arguments for command paste

    ## WARN [2026-07-29 19:13:54] WARNING! Detected list argument(s) for command 'paste', but 'iteration' is set to 'no'.

    ## INFO [2026-07-29 19:13:54]   1 sample x iteration runs for command 'paste':

    ## INFO [2026-07-29 19:13:54]      1 single results.

    ## INFO [2026-07-29 19:13:54] Running step 4 of 4

    ## INFO [2026-07-29 19:13:54] Parsing arguments for command gsub

    ## INFO [2026-07-29 19:13:54]   1 sample x iteration runs for command 'gsub':

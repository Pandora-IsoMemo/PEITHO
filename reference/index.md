...
- [`extract_workflow_from_files()`](https://pandora-isomemo.github.io/PEITHO/reference/extract_workflow_from_files.md)
...
- [`run()`](https://pandora-isomemo.github.io/PEITHO/reference/run.md) :
  Run a workflow step This is a generic function to run a workflow step

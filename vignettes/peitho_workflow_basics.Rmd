...
You can import a workflow from a zip file. Optionally, you can modify the workflow steps (e.g., in `commands.json` or `inputs.json`) before running it:
...
After importing, you can set up a new workflow object using the extracted files:
